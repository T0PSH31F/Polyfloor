...
1. **1F Intake Wizard** (`/new`) — 4-step wizard: goal prompt, grilling
...
1. **Company Lobby** (`/c/{company_id}`) — Top-screen canvas renders lobby
...
1. **Team Room** (`/c/{company_id}/room/{room_id}`) — Top-screen canvas
