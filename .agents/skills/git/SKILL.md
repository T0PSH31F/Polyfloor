---
name: git
description: Fast automated Git workflow to stage changes, run pre-commit checks, generate conventional commit messages, push to GitHub, and sync/merge with main. Triggers on /git or when user requests git sync/commit/push.
---
